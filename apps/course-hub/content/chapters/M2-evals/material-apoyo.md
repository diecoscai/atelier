...
4. **DeepEval — repo y docs oficiales**
...
5. **Chip Huyen — "AI Engineering" (O'Reilly, 2025), capítulos de evaluación (cap. 3-4)**
...
Leé los ★ Core en orden (Hamel #1 y #2 primero — son el método; RAGAS/DeepEval/Huyen después — son
las herramientas y el marco). Antes de abrir `practica.md`, tenés que poder responder *sin mirar*:
(a) por qué error analysis va antes que las métricas, (b) la diferencia entre faithfulness y answer
relevancy, y (c) dos sesgos del LLM-judge y cómo los mitigás. Si las tres salen, estás listo para
